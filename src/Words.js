...
const databaseURL = "https://wordcloud-20188-default-rtdb.firebaseio.com";
        ...
        return(
            <div>
                ...
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        <TextField lagel="단어" type="text" name="word" value={this.state.word || ''} onChange={this.handleValueChange} /><br />
                        <TextField lagel="가중치" type="text" name="weight" value={this.state.weight || ''} onChange={this.handleValueChange} /><br />
                    </DialogContent>
                    <DialogActions>
